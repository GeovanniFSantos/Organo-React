...
function App() {
  ...
  const inicial = [
    ...
    },
    {
      ...
      cargo: 'Horizon Zero Dawn é um jogo eletrônico de RPG de ação pós-apocalíptico em um mundo aberto.',
    ...
    },
    {
      id: uuidv4(),
      nome: 'THE LAST OF US',
      cargo: 'Em uma civilização devastada, em que infectados e sobreviventes veteranos estão à solta.',
